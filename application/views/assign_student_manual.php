                    ...
                    <div class="container-fluid">
                                <div class="card">
                                      <div class="card-body">
                                        ...
                                        <form method="POST" action="<?php echo base_url('dashboard/assign_student_manual'); ?>">
                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                            <div class=" col-md-12">
                                                <div class="form-group">
                                                    <label for="username"> Enter Student Id</label>
                                                    <input type="text" value="" placeholder="Ex:NG0001" class="form-control" name="studentId">
                                                    <span style="color:red"><?php echo form_error('studentId');?></span>
                                                </div>
                                            </div>
                                                <div class=" col-md-12">
  ...
  <script type="text/javascript">
    color = Math.floor((Math.random() * 4) + 1);
      ...
      $.notify({
       ...
       setTimeout(function() {
                     window.location.href = '<?php  echo base_url('dashboard/assign_student_manual')?>';
        }, 2000);
