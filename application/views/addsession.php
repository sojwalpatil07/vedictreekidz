                ...
                <div class="page-content">
                    <div class="container-fluid">
                                <div class="card">
                                      <div class="card-body">
                                           <h1>Add Session</h1>
                                        <form method="POST" action="<?php echo base_url('dashboard/addsession'); ?>">
                                            <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <th class="thclass">session Images</th>
                                                <th class="thclass">Date</th>
                                                <th class="thclass">Action</th>
                                            </tr>
                                            </thead>  
                                            <tbody>
                                               <?php if($listaddsession){
                                                $i=1;
                                                foreach ($listaddsession as $key => $value) { 
                                                    // echo "<pre>";
                                                    // print_r($value);
                                                ?> 
                                            <tr>
                                                ...
                                                <td><img width="100px;" height="100px;" src="<?php echo base_url('uploads/sessionImages/'.$value['sessionImages'] ); ?>"></td>
                                                <td><?php echo $value['createDT']; ?></td>
                                                <td>
                                                    
                                                    <a href="<?php echo base_url('dashboard/edit_session/'.$value['sessionId']); ?>"><i style="font-size:25px;" class="mdi mdi-account-edit-outline"></i></a>
                                                    <!--<form class="" method="POST" onclick="return check();" action="<?php //echo base_url('dashboard/delesessionId');?>">-->
                                                    <!--    <input type="hidden" value="<?php //echo $value['sessionId'];?>" name="sessionId">-->
