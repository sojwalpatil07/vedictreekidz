                ...
                <div class="page-content">
                    <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                      <div class="card-body">
                                        <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('dashboard/edit_gallery_image'); ?>">
                                            <div class="row">
                                                <div class="col-xl-4 col-md-6">
                                                   <div class="form-group" >
                                                        <div class="form-group">
                                                            <label>Upload Gallery Photos </label>
                                                            <input type="file" class="filestyle" name="galleryImage" value="<?php echo $update_gallery_list[0]['galleryImage']; ?>" placeholder="Meta Keywords ">
                                                        </div>
                                                        <span style="color:red"><?php if(isset($error['galleryImage'])){ echo $error['galleryImage']; } ?></span>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="gId" value="<?php echo $update_gallery_list[0]['gId']; ?>">
