                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatables" class="table table-bordered  " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <th class="thclass">Only App Access</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <?php
                                                        ...
                                                        if($value['onlyapplogin']=="1"){

                                                            $status = "<span class='badge badge-sm bg-gradient-success'>Yes</span>";
                                                            $onlyapplogin = 0;
                                                            } else {

                                                            $status = "<span class='badge badge-sm bg-gradient-secondary'>No</span>";
                                                            $onlyapplogin = 1;
                                                        }
                                                ...
                                                <td>
                                                        <input type="hidden" value="<?php echo $onlyapplogin; ?>" class="getstatus<?php echo $value['studId']?>">
...
$(document).ready(function() {
                ...
                $(".changestatus").click(function(){
                    ...
                    $.ajax({
                        ...
                        url:"<?php echo base_url('dashboard/changeaccess')?>",
