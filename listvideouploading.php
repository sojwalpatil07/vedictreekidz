                                        ...
                                        <table id="datatable" class="table table-bordered " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                               <?php if($listvideouploading){
                                                $i=1;
                                                $get_month_data_count = count($get_month_data);
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <?php
                                                     ...
                                                     if(isset($recap) && $recap > 0 ){
                                                        ...
                                                        if(isset($recap) && $recap!=""){ ?>
                                                          <a  href="<?php echo base_url('dashboard/days/'.$value['fk_monthId'].'/'.$fk_classId.'/'.$recap);?>">View Days(<?php echo $get_month_data_count; ?>) <i class="mdi mdi-eye" style="font-size: x-large;    position: relative;top: 5px;"></i></a>
                                                             <?php } else if(isset($coursePeriod) && $coursePeriod > 0){ ?>
                                                             <a  href="<?php echo base_url('dashboard/dayscourse/'.$value['fk_monthId'].'/'.$fk_classId.'/'.$coursePeriod);?>">View Days(<?php echo $get_month_data_count; ?>) <i class="mdi mdi-eye" style="font-size: x-large;    position: relative;top: 5px;"></i></a>
                                                            <?php } else { ?>
                                                         <a href="<?php echo base_url('dashboard/days/'.$value['fk_monthId'].'/'.$fk_classId);?>">View Days(<?php echo $get_month_data_count; ?>) <i class="mdi mdi-eye" style="font-size: x-large;    position: relative;top: 5px;"></i></a>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('dashboard/edit_video/'.$value['vidId'].'/'.$fk_classId)?>"><i style="font-size:25px;" class="mdi mdi-account-edit-outline"></i>
                                                    </a>
